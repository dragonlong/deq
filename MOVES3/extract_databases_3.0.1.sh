...
>databases;
>use c51041y2017_m301_nr_test1_out;
>show tables;
>select * from movesoutput into outfile "/groups/deq/cascades/models/MOVES3.0.1/4-testruns/nonroad_chesterfield/test1_xiaolong/post_proc/movesoutput1.txt";
>exit;
...
# c51041y2017_m301_nr_test1_out
existingInputDatabaseDir=/groups/deq/cascades/models/MOVES3.0.1/4-testruns/nonroad_chesterfield/test1_xiaolong/mysql_out/outputs
# existingInputDatabaseDir=/groups/deq/cascades/models/MOVES3.0.1/4-testruns/nonroad_chesterfield/Sonya_Windows_sqlout
