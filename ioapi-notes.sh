...
https://github.com/USEPA/CMAQ/blob/master/DOCS/Users_Guide/PDF/CMAQ_UG_09_2019.pdf
https://www.cmascenter.org/smoke/documentation/4.7/manual_smokev47.pdf 498
ioapi + netcdf + intel compiler into ioapi_intel/ folder;

cmaq-toolkit;
CMAQ Emissions Calculator Toolkit

cd /groups/deq/Shared/lxiaol9/build/netcdf-c-4.7.4
LIBS="-lhdf5 -lhdf5_hl -lnetcdf"
cd /groups/deq/Shared/lxiaol9/build/netcdf-fortran-4.5.2
configure --help
cmake . -L
