...
# =================================================================== #
 ...
 setenv NEED_LIB /opt/apps/pgi/18.4/linux86-64/18.4/lib/
 setenv LD_LIBRARY_PATH $LD_LIBRARY_PATH":$NEED_LIB"
...
# setenv CMAQ_HOME $cwd
 ...
 setenv CMAQ_HOME /groups/deq/cascades/models/AirQ/CMAQ/CMAQ_v5.3.1/CMAQ_REPO
...
#        setenv MPI_LIB_DIR      mpi_lib_pgi     #> MPI directory path
        ...
        setenv IOAPI_INCL_DIR   /groups/deq/cascades/utils/pgi18.4/ioapi/ioapi-3.2/ioapi/fixed_src
        setenv IOAPI_LIB_DIR    /groups/deq/cascades/utils/pgi18.4/ioapi/ioapi-3.2/Linux2_x86_64pg
        setenv NETCDF_LIB_DIR   /groups/deq/cascades/utils/pgi18.4/netcdf/3.6.3/lib
        setenv NETCDF_INCL_DIR  /groups/deq/cascades/utils/pgi18.4/netcdf/3.6.3/include
        setenv NETCDFF_LIB_DIR  /groups/deq/cascades/utils/pgi18.4/netcdf/3.6.3/lib
        setenv NETCDFF_INCL_DIR /groups/deq/cascades/utils/pgi18.4/netcdf/3.6.3/include
        setenv MPI_LIB_DIR      /opt/apps/pgi18_4/openmpi/3.1.2

        #> Compiler Aliases and Flags
#        setenv myFC mpifort 
        setenv myFC /opt/apps/pgi18_4/openmpi/3.1.2/bin/mpif90
        setenv myCC pgcc
