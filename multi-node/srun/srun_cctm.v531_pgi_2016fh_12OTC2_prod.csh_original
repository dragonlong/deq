...
# =====================================
#>> jeongran yun, 01/22/2020
#>> benchmark case using 2016 v1 (fh), not the final version of platform
#>> run case: 07/16/2016 to 07/25/2016
#>> check the followings:
#>> copy "inp_12OTC2_benchmark" under the ${CMAQ_DATA} directory
#>> copy "output_CCTM_v531_pgi_2016fh_cb6_16j" under the ${CMAQ_DATA} directory
#>> change NROW, NCOL values for your system
#>> fix machinefile for your system
# =====================================
...
# set MPIRUN = /opt/apps/pgi18_4/openmpi/3.1.2/bin/mpirun

 source /groups/deq/cascades/models/AirQ/CMAQ/CMAQ_v5.3.1/CMAQ_REPO/config_cmaq.csh

 setenv CMAQ_DATA   /groups/deq/cascades/data/2016/2016v1_CMAQ531_fiveO3months   # 2016v1 or 2016fh
 setenv CMAQ_DATA_b /groups/deq/cascades/data/2016/2016v1_CMAQ531_benchmark    # 2016ff or beta version

#> Set General Parameters for Configuring the Simulation
 set VRSN      = v531              #> Code Version
 set PROC      = mpi               #> serial or mpi
 set MECH      = cb6r3_ae7_aq      #> Mechanism ID
 set APPL      = 2016fh_cb6_16j  #> Application Name (e.g. Gridname)
...
# setenv OUTDIR  ${CMAQ_DATA}/output_CCTM_${RUNID}  #> Output Directory
 ...
 setenv WORKDIR /groups/deq/cascades/sims/CMAQ5.3/trial/scripts
 setenv OUTDIR  /groups/deq/cascades/sims/CMAQ5.3/trial/output_trial
 setenv INPDIR    ${CMAQ_DATA}/2016fh          #> Input Directory
 setenv INPDIR_b  ${CMAQ_DATA_b}/inp_12OTC2_benchmark/cctm_input  #> Input 
...
# set START_DATE = "2016-07-16"     #> beginning date (July 1, 2016)
# set END_DATE   = "2016-07-17"     #> ending date    (July 14, 2016)
# set START_DATE = "2016-07-24"     #> beginning date (July 1, 2016)
# set END_DATE   = "2016-07-25"     #> ending date    (July 14, 2016)

# setenv NEW_START TRUE            #> Set to FALSE for model restart
# setenv NEW_START FALSE            #> 0430 CGRID provided
# set START_DATE = "2016-05-01"     #> 
# set END_DATE   = "2016-05-02"     #> 

 setenv NEW_START FALSE            #> 0430 CGRID provided, so restart
 set START_DATE = "2016-05-01"     #> 
 set END_DATE   = "2016-05-05"     #> 
...
#   @ NPCOL  =  7; @ NPROW =  8    ##jyun
   @ NPCOL  =  8; @ NPROW =  8    ##jyun
#   @ NPCOL  =  9; @ NPROW = 9    # segmentation fault
   @ NPROCS = $NPCOL * $NPROW
...
setenv GRID_NAME 12OTC2         #> check GRIDDESC file for GRID_NAME options
...
set ICpath    = ${INPDIR_b}/icbc                    #> initial conditions input directory 
set BCpath    = $INPDIR/bcon/12OTC2                 #> boundary conditions input directory
set EMISpath  = $INPDIR/emis/emis.2016v1/2016fh_16j/12otc2/emis2d_anthro_bio_norwc
set EMISpath2 = $INPDIR/emis/emis.2016v1/2016fh_16j/12otc2/rwc

set IN_PTpath = $INPDIR/emis/emis.2016v1/2016fh_16j/12otc2/inln_point
#set IN_PTpath = ${INPDIR_b}/emis/inln_point

set IN_LTpath = $INPDIR/lightning                   #> lightning NOx input directory
set METpath   = $INPDIR/mcip5.2016/12OTC2           #> meteorology input directory 
...
set LUpath    = ${INPDIR}/surface/festc
set LUpath_b  = ${INPDIR_b}/land                 #> BELD landuse data for windblown dust model
set SZpath    = ${INPDIR}/surface/festc          #> surf zone file for in-line seaspray emissions
set SZpath_b  = ${INPDIR_b}/land                 #> surf zone file for in-line seaspray emissions
...
#     setenv ICFILE ICON_20160630_bench.nc
     setenv ICFILE ICON_v52_M_12OTC_profile
  ...
  setenv CMAQ_MASKS ${SZpath_b}/12US1_surf.12otc2.ncf #> horizontal grid-dependent surf zone file

  #> Gridded Emissions Files 
  setenv N_EMIS_GR 2
  set EMISfile = emis_mole_all_${YYYYMMDD}_12US1_withbeis_2016fh_16j_12OTC2.ncf
  
  setenv GR_EMIS_001 ${EMISpath}/${EMISfile}
  setenv GR_EMIS_LAB_001 GRIDDED_EMIS
  setenv GR_EM_SYM_DATE_001 F

  set EMISfile2  = emis_mole_rwc_${YYYYMMDD}_12US1_cmaq_cb6_2016fh_16j_12OTC2.ncf
  setenv GR_EMIS_002 ${EMISpath2}/${EMISfile2}
...
#	set reffile = ${IN_PTpath}/../smk_dates/2016/smk_merge_dates_${YYYYMM}.txt
  ...
  setenv OCEAN_1 ${SZpath_b}/12US1_surf.12otc2.ncf #> horizontal grid-dependent surf zone file

  #> Bidirectional ammonia configuration
  if ( $CTM_ABFLUX == 'Y' ) then
     setenv E2C_SOIL ${LUpath}/toCMAQ_festc1.4_epic/12OTC2/us1_2016_cmaq12km_soil.12otc2.ncf
     setenv E2C_CHEM ${LUpath}/toCMAQ_festc1.4_epic/12OTC2/us1_2016_cmaq12km_time${YYYYMMDD}.12otc2.ncf
     setenv E2C_CHEM_YEST ${LUpath}/toCMAQ_festc1.4_epic/12OTC2/us1_2016_cmaq12km_time${YESTERDAY}.12otc2.ncf
     setenv E2C_LU ${LUpath_b}/beld41_feb2017_waterfix_envcan_12US2.12OTC2.ncf
  endif
...
#  set TASKMAP = ./machines56.airclust3		##jyun
#  ( /usr/bin/time -p mpirun --bind-to core -machinefile $TASKMAP -np $NPROCS $BLD/$EXEC )|& tee buff_${EXECUTION_ID}.txt
  
# srun -n56 --mpi=pmi2 $BLD/$EXEC
 srun -n64 --mpi=pmi2 $BLD/$EXEC

#if( ! { $MPIRUN -n $NPROCS $BLD/$EXEC } ) then
#   exit
#endif

#  $MPIRUN -n $NPROCS $BLD/$EXEC 
