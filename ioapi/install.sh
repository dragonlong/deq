...
export FINSTDIR=/groups/deq/cascades/utils_intel/intel18.2/netCDF-f/4.5.2
...
module purge
module load intel/18.2 hdf5/1.8.16 cmake/3.10.3
export CINSTDIR='/groups/deq/cascades/utils_intel/intel18.2/netCDF/4.7.4'
export FINSTDIR='/groups/deq/cascades/utils_intel/intel18.2/netCDF-f/4.5.2'
export IOAPIDIR='/groups/deq/cascades/utils_intel/intel18.2/ioapi/3.2/'
...
# test
cp -r tests/ ${IOAPIDIR}/
./ioapitest.csh '/groups/deq/cascades/utils_intel/intel18.2/ioapi/3.2/' 'Linux2_x86_64ifort'
# copy the dfixed_src folder
